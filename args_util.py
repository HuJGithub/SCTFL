...
def parse_args(args):
    ...
    if config_dict["-e"] not in ["origin", "slice","slice_smote", "cc", "ccknn", "cc_bsmote", "cc_smote","slice_ga", "ga", "slice_bsmote", "slice_cvae", "slice_mixup","resampling", "undersampling", "fs", "cvae", "fs_cvae", "smote","bsmote", "mixup", "lda_cvae","lda_smote"]:
